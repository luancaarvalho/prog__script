(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser-dynamic'), require('rxjs/operators'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('angular-playground', ['exports', '@angular/core', '@angular/platform-browser', '@angular/common', '@angular/forms', '@angular/platform-browser-dynamic', 'rxjs/operators', 'rxjs'], factory) :
    (global = global || self, factory(global['angular-playground'] = {}, global.ng.core, global.ng.platformBrowser, global.ng.common, global.ng.forms, global.ng.platformBrowserDynamic, global.rxjs.operators, global.rxjs));
}(this, (function (exports, core, platformBrowser, common, forms, platformBrowserDynamic, operators, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function getSandbox(path) {
        /*GET_SANDBOX*/
        /*END_GET_SANDBOX*/
    }
    function getSandboxMenuItems() {
    ...
    var MIDDLEWARE = new core.InjectionToken('middleware');
    ...
    var ScenarioComponent = /** @class */ (function () {
        ...
        ScenarioComponent.ctorParameters = function () { return [
            { type: core.NgZone },
            { type: undefined, decorators: [{ type: core.Inject, args: [MIDDLEWARE,] }] }
        ]; };
        __decorate([
            core.Input()
        ...
        ScenarioComponent = __decorate([
            ...
            __param(1, core.Inject(MIDDLEWARE))
        ], ScenarioComponent);
    ...
    var AppComponent = /** @class */ (function () {
        ...
        AppComponent.prototype.ngOnInit = function () {
            ...
            if (this.embed) {
                ...
                this.filter.valueChanges.pipe(operators.debounceTime(300), operators.distinctUntilChanged())
        ...
        AppComponent.ctorParameters = function () { return [
            ...
            { type: rxjs.Observable, decorators: [{ type: core.Inject, args: [MIDDLEWARE,] }] }
        ]; };
        __decorate([
            core.ViewChildren('scenarioElement')
        ...
        AppComponent = __decorate([
            ...
            __param(5, core.Inject(MIDDLEWARE))
        ], AppComponent);
        return AppComponent;
    }());
    ...
    var HighlightSearchMatchPipe = /** @class */ (function () {
        ...
        HighlightSearchMatchPipe = __decorate([
            core.Pipe({ name: 'apHighlightSearchMatch', pure: false })
    ...
    var DrawerComponent = /** @class */ (function () {
        function DrawerComponent() {
            this.openCommandBarClick = new core.EventEmitter();
        }
        ...
        DrawerComponent = __decorate([
            core.Component({
                ...
                styles: [".link{-webkit-box-align:center;align-items:center;background:#252526;border-radius:50%;bottom:20px;box-shadow:0 0 8px 2px rgba(0,0,0,.5);color:rgba(255,255,255,.5);cursor:pointer;display:-webkit-box;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;flex-direction:column;font-family:Arial,sans-serif;font-size:8px;font-weight:700;height:45px;-webkit-box-pack:center;justify-content:center;position:fixed;right:20px;text-align:center;text-transform:uppercase;-webkit-transition:opacity .5s,-webkit-transform .1s;transition:transform .1s,opacity .5s,-webkit-transform .1s;width:45px;z-index:10000}.link::before{background:-webkit-gradient(linear,left top,left bottom,from(rgba(255,255,255,.5)),color-stop(20%,rgba(255,255,255,.5)),color-stop(20%,transparent),color-stop(40%,transparent),color-stop(40%,rgba(255,255,255,.5)),color-stop(60%,rgba(255,255,255,.5)),color-stop(60%,transparent),color-stop(80%,transparent),color-stop(80%,rgba(255,255,255,.5)),to(rgba(255,255,255,.5)));background:linear-gradient(to bottom,rgba(255,255,255,.5),rgba(255,255,255,.5) 20%,transparent 20%,transparent 40%,rgba(255,255,255,.5) 40%,rgba(255,255,255,.5) 60%,transparent 60%,transparent 80%,rgba(255,255,255,.5) 80%,rgba(255,255,255,.5) 100%);content:'';height:10px;margin-bottom:4px;width:16px}.link:hover{-webkit-transform:scale(1.15);transform:scale(1.15)}:host(.content__menu--hide) .link{opacity:0}"]
            })
        ], DrawerComponent);
    ...
    var initializePlayground = function (elementNameToReplace) {
    ...
    var _middleware = new rxjs.BehaviorSubject({
        selector: null,
        overlay: false,
        modules: [],
    });
    ...
    var PlaygroundModule = /** @class */ (function () {
        ...
        PlaygroundModule.configure = function (configuration) {
            ...
            _middleware.next(__assign(__assign({}, _middleware.value), configuration));
            return this;
        };
    ...
    function sandboxOf(type, config) {
        return new SandboxBuilder(type, config);
    }

    exports.PlaygroundModule = PlaygroundModule;
    exports.SandboxBuilder = SandboxBuilder;
    exports.sandboxOf = sandboxOf;
    exports.ɵ0 = ɵ0;
    exports.ɵa = PlaygroundCommonModule;
    exports.ɵb = StateService;
    exports.ɵc = UrlService;
    exports.ɵd = LevenshteinDistance;
    exports.ɵe = AppComponent;
    exports.ɵg = MIDDLEWARE;
    exports.ɵh = ScenarioComponent;
    exports.ɵi = FocusDirective;
    exports.ɵj = HighlightSearchMatchPipe;
    exports.ɵk = LogoComponent;
    exports.ɵl = PinComponent;
    exports.ɵm = DrawerComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular-playground.umd.js.map
