...
function configure(argv) {
    commander
        ...
        .option('--report-type <type>', 'Type of report to generate', error_reporter_1.REPORT_TYPE.LOG)
...
function applyConfigurationFile(program) {
    ...
    if (config.verifySandboxes && config.reportType && !config.reportPath) {
        switch (config.reportType) {
            case error_reporter_1.REPORT_TYPE.JSON:
                config.reportPath = './sandbox.report.json';
                break;
            case error_reporter_1.REPORT_TYPE.XML:
